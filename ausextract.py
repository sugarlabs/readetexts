...
# This is a script to take the file GUTINDEX.AUS, the offline book catalog of
# Project Gutenberg Australia, and reformat it for use by Read Etexts.
# After the file ausoutput.txt is created it should be combined with the
# output of gutextract.py and sorted to create bookcatalog.txt.
